...
sobre el mismo núcleo, pendiente de probar en navegador). **T2 hecho**: `spike/vis/paso-anvil.qvi`
compila a componente WASM con la interfaz `anvil:paso` y Anvil lo ejecuta como paso de una
secuencia (`spike/anvil/`, y el apartado T2 de `spike/README.md`).
